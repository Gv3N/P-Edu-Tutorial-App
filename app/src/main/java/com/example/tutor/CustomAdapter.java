...
public class CustomAdapter extends SimpleAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            if(convertView==null)
                vi = inflater.inflate(R.layout.cust_list_tutorial, null);
            ...
            String dadd =(String) data.get("tutor");
            String dloc =(String) data.get("location");
            String drid=(String) data.get("courseID");
            tvrestname.setText(dname);
            tvphone.setText(dphone);
            tvadd.setText(dadd);
            tvloc.setText(dloc);
            String image_url = "http://githubbers.com/jivan/courseimg/"+drid+".png";
